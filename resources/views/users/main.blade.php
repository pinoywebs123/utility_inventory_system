...
<div class="container">
		...
		<div class="panel panel-primary row">
			...
			<div class="panel-body">
				...
				<ul class="nav nav-pills nav-stacked">
				  <li role="presentation" class="active"><a href="{{route('user_main')}}">Activity History</a></li>
				  <li role="presentation"><a href="{{route('user_mr')}}">M.R</a></li>
	...
	<div class="col-md-9 ">
		<div class="panel panel-primary row">
			<div class="panel-heading">
				<h3 class="text-center">Returnable Item List</h3>
			</div>
			<div class="panel-body">
